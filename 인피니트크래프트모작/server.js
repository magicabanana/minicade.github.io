...
// Rate limiting: max 30 requests per minute per IP for the combine endpoint
...
Example: {"emoji": "💨", "word": "Steam"} if the inputs were Water and Fire.`;
        ...
        // We use the dynamic import for node-fetch if using older node, or built-in fetch for Node 18+
        // Assuming Node 18+ environment on Render
